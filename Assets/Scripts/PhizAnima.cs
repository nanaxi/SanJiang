...
public class PhizAnima : MonoBehaviour {
    ...
    void Start () {
        ...
        phizImgs =transform.FindChild("Phiz_Bg").GetComponentsInChildren<Image>(true);
        chat_Shows = transform.FindChild("Chat_Bg").GetComponentsInChildren<TextParentSize_>(true);
        Init_CloseShow();
    }
