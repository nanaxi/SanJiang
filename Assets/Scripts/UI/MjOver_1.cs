...
public class MjOver_1 : MonoBehaviour {
    ...
    public void Init()
    {
        ...
        for (int i = 0; i < end_Mj_P_UI.Length; i++)
        {
            ...
            end_Mj_P_UI[i].NewEnd_MaJiang_Player_Gm_UI(transform.FindChild("Img_Bg0/Img_Layout_Bg/Img_Player_Bg_" + i));
            end_Mj_P_UI[i].mjOverManage = this;
        }
        t_Time = transform.FindChild("Img_Bg0/T_Time").GetComponent<Text>();
        t_Time.text = "";
        t_AllMjLayout = transform.FindChild("Img_Bg0/Img_Layout");
        t_TouMingLayout = transform.FindChild("Img_Bg0/Img_TouMingLayout");
        t_Img_AnPaiLayout = transform.FindChild("Img_Bg0/Img_AnPaiLayout");
        ...
        btn_EndStart = transform.FindChild("Img_Bg0/Img_BtnBg_0/Btn_MjEnd_Start_Game").GetComponent<Button>();
        btn_EndQueDing = transform.FindChild("Img_Bg0/Img_BtnBg_0/Btn_EndQueDing").GetComponent<Button>();
