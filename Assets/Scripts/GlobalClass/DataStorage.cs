...
public class Start_Mj_NeedUI
{
    ...
    public Start_Mj_NeedUI(Transform window_MaJiang)
    {
        ...
        t_RoomID = window_MaJiang.FindChild("Top_Left/T_RoomID").GetComponent<Text>();
        t_RoomInfo = window_MaJiang.FindChild("Top_Left/T_RoomInfo").GetComponent<Text>();
        t_ShengYuPaiShu = window_MaJiang.FindChild("Top_Left/T_ShengYuPaiShu").GetComponent<Text>();
        t_ShengYuJuShu = window_MaJiang.FindChild("Top_Left/T_ShengYuJuShu").GetComponent<Text>();
        t_RoomTime = window_MaJiang.FindChild("Top_Left/T_RoomTime").GetComponent<Text>();
        prepAllBg = window_MaJiang.FindChild("PrepAllBg").gameObject;
        //t_GameTime = window_MaJiang.FindChild("T_GameTime").GetComponent<Text>();
        img_Mj_Btn_Cz_Bg = window_MaJiang.FindChild("Img_Mj_Btn_Cz_Bg").GetComponent<RectTransform>();
        btn_Peng_Pai = img_Mj_Btn_Cz_Bg.FindChild("Btn_Peng_Pai").GetComponent<RectTransform>();
        btn_Gang_Pai = img_Mj_Btn_Cz_Bg.FindChild("Btn_Gang_Pai").GetComponent<RectTransform>();
        btn_Hu_Pai = img_Mj_Btn_Cz_Bg.FindChild("Btn_Hu_Pai").GetComponent<RectTransform>();
        btn_Guo_Pai = img_Mj_Btn_Cz_Bg.FindChild("Btn_Guo_Pai").GetComponent<RectTransform>();
        btn_BaoPai = img_Mj_Btn_Cz_Bg.FindChild("Btn_BaoPai").GetComponent<RectTransform>();
        btn_FeiPai = img_Mj_Btn_Cz_Bg.FindChild("Btn_FeiPai").GetComponent<RectTransform>();
        btn_TiPai = img_Mj_Btn_Cz_Bg.FindChild("Btn_TiPai").GetComponent<RectTransform>();

        btn_SetoutStart = window_MaJiang.FindChild("Btn_SetoutStart").GetComponent<RectTransform>();
        img_ZhuangJia = window_MaJiang.FindChild("All_PlayerUiBg/Img_ZhuangJia").GetComponent<RectTransform>();

        Transform btn_V_Chat_T = window_MaJiang.FindChild("Btn_OpenSendVoice");
...
public class End_MaJiang_Player_Gm_UI
{
    ...
    public void NewEnd_MaJiang_Player_Gm_UI(Transform img_Player_Bg_0)
    {
        ...
        t_Name = img_Player_Bg_0.FindChild("T_Name").GetComponent<Text>();
        t_DiFen = img_Player_Bg_0.FindChild("T_DiFen").GetComponent<Text>();
        t_HuPai_Prompt = img_Player_Bg_0.FindChild("T_HuPai_Prompt").GetComponent<Text>();
        t_Gold_Change = img_Player_Bg_0.FindChild("T_Gold_Change").GetComponent<Text>();
        img_Layout = img_Player_Bg_0.FindChild("Img_Layout");
        img_Yn_HuPai = img_Player_Bg_0.FindChild("Img_Yn_HuPai").GetComponent<Image>();
    ...
    public void Add_EndMjGai(string p_End_Mj_Name, int i_)
    {
        ...
        switch (i_)
        {
            ...
            case 1:
                ...
                end_Mj.FindChild("Img_PaiMian").GetComponent<Image>().sprite = Resources.Load<Sprite>("Sprites/NingXiaHuaShui/MJUI/paimian/" + p_End_Mj_Name);
...
public class Player_Data
{
    ...
    public Player_Data(string Name, uint ID, string IP, string Head, int Diamond, int Money, int sex_1)
    {
        P_Name = Name.ToName();
        p_ID = ID;
        p_Ip = IP;
    ...
    public Player_Data ReSetPlayerData(ProtoBuf.CharacterInfo info, ProtoBuf.CharacterState stateinfo, int num, uint yn_Zb)
    {
        ...
        //PE.Fun_headImage(_AllPlayerData[num].Head);// 头像咱无使用
        P_Name = info.userName.ToName();
        p_ID = info.charId;
        p_Ip = info.ip;
